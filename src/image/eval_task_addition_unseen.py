...
args.eval_datasets = ["RESISC45", "SVHN"]
test_metrics_unseen = evaluate_task_vector_at_coef(
    task_vector,
    pretrained_checkpoint,
    args,
    float(optimal_coef),
...
additive_accuracies = {"test_unseen": test_metrics_unseen, "test": test_metrics, "val": val_metrics}

if args.finetuning_mode == "standard":
    save_file = f"{args.save}/additions_unseen.json"
elif args.finetuning_mode == "linear":
    save_file = f"{args.save}/linear_additions_unseen.json"
elif args.finetuning_mode == "posthoc":
    save_file = f"{args.save}/posthoc_additions_unseen.json"
