...
for check_point in [0, 100, 200, 300, 400, 500, 600, 700, 800, 900, 1000]:
    ...
    for dataset in [
        ...
        finetuned_checkpoint = (
            f"{args.save}/{dataset}Val/linear_checkpoint_{check_point}.pt"
            if args.finetuning_mode == "linear" or args.finetuning_mode == "none"
        ...
        for split in ["test", "val"]:
            ...
            accuracies[check_point][eval_dataset] = eval_single_dataset(
    ...
    if args.finetuning_mode == "none":
        ...
        for split in ["ImageNetVal", "ImageNet"]:
            accuracies[check_point][split] = eval_single_dataset(image_encoder, split, args)["top1"]
